    ...
    <div className="min-h-screen bg-[var(--brand-page)] text-[var(--brand-text)]">
      <header className="brand-header-surface fixed inset-x-0 top-0 z-50">
        <div className="mx-auto flex h-16 w-full max-w-[430px] items-center justify-between px-4">
          ...
          <p className="text-sm font-extrabold text-[var(--brand-text)]">내 정산</p>
      ...
      <main className="mx-auto flex w-full max-w-[430px] flex-col gap-4 px-4 pb-12 pt-24">
        <section className="brand-card-soft rounded-3xl p-5">
          ...
          <div className="mt-2 flex items-end justify-between gap-4">
            <h1 className="font-headline text-[1.75rem] font-extrabold tracking-[-0.04em] text-[var(--brand-text)]">모임별로 확인하세요</h1>
            ...
            <section key={meeting.id} className="brand-card-soft rounded-3xl p-5">
              <div className="mb-4 flex items-start justify-between gap-3 border-b border-[var(--brand-divider)] pb-4">
                <div>
                  ...
                  <p className="mt-1 text-base font-extrabold text-[var(--brand-text)]">{meeting.location}</p>
                ...
                <div className="shrink-0 text-right">
                  ...
                  <p className="mt-1 text-lg font-extrabold text-[var(--brand-text)]">{formatWon(group.totalFee)}</p>
                </div>
              </div>
