      ...
      <header className="fixed inset-x-0 top-0 z-50 bg-white/70 shadow-[0_8px_24px_rgba(26,28,28,0.06)] backdrop-blur-xl">
        <div className="mx-auto flex h-16 w-full max-w-[390px] items-center justify-between px-4">
          <div className="flex h-9 items-center">
            <Image alt="Surfing club logo" className="h-auto w-[44px]" height={44} priority src="/logo.png" width={44} />
          </div>
      ...
      <main className={`mx-auto flex w-full max-w-[390px] flex-col gap-10 px-4 pb-12 ${topOffsetClass}`}>
        <section>
          <div className="mb-6 flex items-end justify-between">
            <div>
              <h1 className="font-headline text-[2.5rem] font-extrabold leading-none tracking-[-0.06em]">
