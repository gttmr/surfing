    ...
    <AdminLayout dirtyNavigation={{ isDirty: dirtySectionCount > 0, isSaveInFlight: saving, onDiscard: discardDraft }}>
      <div className="space-y-4">
        <header className="space-y-3">
          <div>
            <p className="brand-text-subtle text-xs font-semibold">관리자 · 요금 정책</p>
            <h1 className="font-headline text-[1.7rem] font-extrabold tracking-[-0.03em] text-brand-text">요금·지원 정책</h1>
            <p className="brand-text-muted mt-1 text-sm">회원 부담액과 동호회 지원 기준을 구분해 확인하고 편집합니다.</p>
          </div>
