        ...
        <div className="flex items-start gap-3">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <p className="truncate text-sm font-bold text-[var(--brand-text)]">{recipient.recipientName}</p>
          ...
          <div className="flex shrink-0 items-start gap-2">
            ...
            <Icon className="mt-0.5 text-[20px] text-[var(--brand-text-subtle)]" name={expanded ? "expand_less" : "expand_more"} />
          </div>
        </div>
      </button>
